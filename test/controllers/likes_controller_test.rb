...
class LikesControllerTest < ActionController::TestCase
  ...
  test "should create like" do
    assert_difference('Like.count') do
      post :create, like: { accomplishment_id: @like.accomplishment_id, user_id: @like.user_id }
    end
  ...
  test "should update like" do
    patch :update, id: @like, like: { accomplishment_id: @like.accomplishment_id, user_id: @like.user_id }
    assert_redirected_to like_path(assigns(:like))
  end
